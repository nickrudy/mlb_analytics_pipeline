...
# 3x3 in-zone grid (Statcast zones 1-9 mapped to row/col)
# Zone layout (catcher view): 1=top-left, 2=top-mid, 3=top-right
#                              4=mid-left, 5=center,  6=mid-right
#                              7=bot-left, 8=bot-mid, 9=bot-right
ZONES = [
    # code        bucket            group     row col in_sz  x_min  x_max  z_min  z_max
...
SPLIT_WINDOWS = [
    # code    name            start_rule        end_rule         min_pa  min_bf  regr_wt
...
if __name__ == "__main__":
    ...
    parser.add_argument("--db-path", default="data/mlb_pregame.db", help="Path to .db file")
